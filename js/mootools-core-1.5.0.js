/*
 ...
 web build:
 - http://mootools.net/core/6094152ebca6b1ab8dc7c8d48be22087
...
(function () {
    this.MooTools = {version: "1.5.0", build: "0f7b690afee9349b15909f33016a25d2e4d9f4e3"};
...
String.implement({contains: function (b, a) {
...
(function () {
    ...
    var a = function (k, e) {
        k = k.toLowerCase();
        e = (e ? e.toLowerCase() : "");
        var l = k.match(/(opera|ie|firefox|chrome|trident|crios|version)[\s\/:]([\w\d\.]+)?.*?(safari|(?:rv[\s\/:]|version[\s\/:])([\w\d\.]+)|$)/) || [null, "unknown", 0];
        if (l[1] == "trident") {
            l[1] = "ie";
            if (l[4]) {
                l[2] = l[4];
        ...
        var e = k.match(/ip(?:ad|od|hone)/) ? "ios" : (k.match(/(?:webos|android)/) || e.match(/mac|win|linux/) || ["other"])[0];
        if (e == "win") {
            e = "windows";
        }
        return{extend: Function.prototype.extend, name: (l[1] == "version") ? l[3] : l[1], version: parseFloat((l[1] == "opera" && l[4]) ? l[4] : l[2]), platform: e};
    };
    var j = this.Browser = a(navigator.userAgent, navigator.platform);
    if (j.ie) {
        j.version = f.documentMode;
    }
    ...
    String.implement("stripScripts", function (k) {
        var e = "";
        var l = this.replace(/<script[^>]*>([\s\S]*?)<\/script>/gi, function (m, n) {
            e += n + "\n";
            return"";
        });
        if (k === true) {
    ...
    try {
        ...
        Array.from = function (k) {
            if (typeof k != "string" && Type.isEnumerable(k) && typeOf(k) != "array") {
                var e = k.length, l = new Array(e);
                while (e--) {
                    l[e] = k[e];
                }
                return l;
        ...
        ["pop", "push", "reverse", "shift", "sort", "splice", "unshift", "concat", "join", "slice"].each(function (e) {
            var k = h[e];
            Array[e] = function (l) {
                return k.apply(Array.from(l), i.call(arguments, 1));
            };
        });
    }
})();
...
(function () {
    ...
    k.setDocument = function (w) {
        ...
        if (s.isHTMLDocument) {
            ...
            s.nativeMatchesSelector = A.matches || A.mozMatchesSelector || A.webkitMatchesSelector;
...
(function () {
    ...
    Document.implement({newTextNode: function (e) {
        ...
        var e = {string: function (L, K, l) {
            L = Slick.find(l, "#" + L.replace(/(\W)/g, "\\$1"));
            return(L) ? e.element(L, K) : null;
        }, element: function (K, L) {
            Slick.uidOf(K);
            if (!L && !K.$family && !(/^(?:object|embed)$/i).test(K.tagName)) {
                var l = K.fireEvent;
                K._fireEvent = function (M, N) {
                    return l(M, N);
                };
                Object.append(K, Element.Prototype);
            }
            return K;
        }, object: function (K, L, l) {
            if (K.toElement) {
                return e.element(K.toElement(l), L);
            }
            return null;
        }};
        ...
        return function (K, M, L) {
            if (K && K.$family && K.uniqueNumber) {
                return K;
            }
            var l = typeOf(K);
            return(e[l]) ? e[l](K, M, L || document) : null;
        };
    })()});
    if (window.$ == null) {
    ...
    Element.implement({getFirst: function (e) {
        return document.id(Slick.search(this, v(e, ">"))[0]);
    }, getLast: function (e) {
    ...
    var A = {before: function (l, e) {
        ...
        var K = e.parentNode;
        if (K) {
            K.insertBefore(l, e.nextSibling);
        }
    }, bottom: function (l, e) {
        e.appendChild(l);
    }, top: function (l, e) {
    ...
    o.html = "innerHTML";
    o.text = (document.createElement("div").textContent == null) ? "innerText" : "textContent";
    Object.forEach(o, function (l, e) {
        d[e] = function (K, L) {
            K[l] = L;
        };
        n[e] = function (K) {
    ...
    Element.implement({setProperty: function (l, K) {
        ...
        if (u) {
            var l = this.getAttributeNode(M), L = this.retrieve("$attributeWhiteList", {});
            if (!l) {
                return null;
            }
            if (l.expando && !L[M]) {
                var N = this.outerHTML;
                if (N.substr(0, N.search(/\/?['"]?>(?![^<]*<['"])/)).indexOf(M) < 0) {
                    return null;
                }
                L[M] = true;
            }
        }
        var e = Slick.getAttribute(this, M);
        return(!e && !Slick.hasAttribute(this, M)) ? null : e;
        ...
        var e = Element.Properties[K];
        (e && e.set) ? e.set.call(this, l) : this.setProperty(K, l);
        ...
        return this;
    }, hasClass: j ? function (e) {
        return this.classList.contains(e);
    } : function (e) {
        return this.className.clean().contains(e, " ");
    }, addClass: j ? function (e) {
        F(e).forEach(t, this);
        return this;
    } : function (e) {
        this.className = F(e + " " + this.className).join(" ");
        return this;
    }, removeClass: j ? function (e) {
        F(e).forEach(g, this);
        return this;
    } : function (e) {
        var l = F(this.className);
        F(e).forEach(l.erase, l);
        ...
        var L = this, e, N = Array.flatten(arguments), M = N.length;
        if (M > 1) {
            L = e = document.createDocumentFragment();
        }
        for (var K = 0; K < M; K++) {
            var l = document.id(N[K], true);
            if (l) {
                L.appendChild(l);
            }
        }
        ...
        A[e || "bottom"](document.id(l, true), this);
        return this;
    }, inject: function (l, e) {
        A[e || "bottom"](this, document.id(l, true));
        return this;
    }, replaces: function (e) {
        ...
        var e = [];
        this.getElements("input, select, textarea").each(function (K) {
            var l = K.type;
            if (!K.name || K.disabled || l == "submit" || l == "reset" || l == "file" || l == "image") {
                return;
            }
            var L = (K.get("tag") == "select") ? K.getSelected().map(function (M) {
                return document.id(M).get("value");
            }) : ((l == "radio" || l == "checkbox") && !K.checked) ? null : K.get("value");
            Array.from(L).each(function (M) {
    ...
    Element.implement("appendHTML", ("insertAdjacentHTML" in document.createElement("div")) ? function (l, e) {
        this.insertAdjacentHTML(I[e || "bottom"], l);
        return this;
    } : function (P, M) {
        var K = new Element("div", {html: P}), O = K.childNodes, L = K.firstChild;
        if (!L) {
            return this;
        }
        if (O.length > 1) {
    ...
    Element.implement({destroy: function () {
        var e = z(this).getElementsByTagName("*");
        Array.each(e, z);
        ...
        N = N !== false;
        var S = this.cloneNode(N), K = [S], M = [this], Q;
        if (N) {
            K.append(Array.from(S.getElementsByTagName("*")));
            M.append(Array.from(this.getElementsByTagName("*")));
        }
        for (Q = K.length; Q--;) {
            var O = K[Q], R = M[Q];
            if (!L) {
            ...
            if (O.clearAttributes) {
                ...
                if (O.options) {
                    var V = O.options, e = R.options;
                    for (var P = V.length;
                         P--;) {
                        V[P].selected = e[P].selected;
                    }
                }
            }
            var l = H[R.tagName.toLowerCase()];
            if (l && R[l]) {
                O[l] = R[l];
            }
        }
    ...
    [Element, Window, Document].invoke("implement", {addListener: function (l, e) {
        ...
        var L = G(Slick.uidOf(this)), K = L[l];
        if (e != null && K == null) {
            K = L[l] = e;
        }
        return K != null ? K : null;
    }, store: function (l, e) {
        var K = G(Slick.uidOf(this));
        K[l] = e;
        return this;
    }, eliminate: function (e) {
        var l = G(Slick.uidOf(this));
        delete l[e];
        return this;
    }});
    if (window.attachEvent && !window.addEventListener) {
        var J = function () {
            ...
            window.removeListener("unload", J);
        };
    ...
    var a = true, h = true, C = true;
    var x = document.createElement("div");
    x.innerHTML = "<nav></nav>";
    a = (x.childNodes.length == 1);
    if (!a) {
    ...
    if (!h || !C || !a) {
        Element.Properties.html.set = (function (l) {
            ...
            return function (K) {
                ...
                var O = L[0], N = document.createElement("div"), M = N;
                if (!a) {
                    b.appendChild(N);
                }
                N.innerHTML = [L[1], K, L[2]].flatten().join("");
                while (O--) {
                    M = M.firstChild;
                }
                this.empty().adopt(M.childNodes);
                if (!a) {
                    b.removeChild(N);
                }
                N = null;
    ...
    if (q.firstChild.value != "s") {
        Element.Properties.value = {set: function (N) {
            var l = this.get("tag");
            if (l != "select") {
                return this.setProperty("value", N);
            }
            var K = this.getElements("option");
            N = String(N);
            for (var L = 0; L < K.length; L++) {
                var M = K[L], e = M.getAttributeNode("value"), O = (e && e.specified) ? M.value : M.get("text");
                if (O === N) {
                    return M.selected = true;
                }
            }
        }, get: function () {
            var K = this, l = K.get("tag");
            if (l != "select" && l != "option") {
                return this.getProperty("value");
            }
            if (l == "select" && !(K = K.getSelected()[0])) {
                return"";
            }
            var e = K.getAttributeNode("value");
            return(e && e.specified) ? K.value : K.get("text");
        }};
    }
    q = null;
...
(function () {
    var l = document.html, f;
    f = document.createElement("div");
    f.style.color = "red";
    f.style.color = null;
    var e = f.style.color == "red";
    var k = "1px solid #123abc";
    f.style.border = k;
    var o = f.style.border != k;
    f = null;
    var n = !!window.getComputedStyle;
    Element.Properties.styles = {set: function (r) {
        this.setStyles(r);
    }};
    var j = (l.style.opacity != null), g = (l.style.filter != null), q = /alpha\(opacity=([\d.]+)\)/i;
    var b = function (s, r) {
        s.store("$opacity", r);
        s.style.visibility = r > 0 || r == null ? "visible" : "hidden";
    };
    var p = function (r, v, u) {
        var t = r.style, s = t.filter || r.getComputedStyle("filter") || "";
        t.filter = (v.test(s) ? s.replace(v, u) : s + " " + u).trim();
        if (!t.filter) {
            t.removeAttribute("filter");
        }
    };
    var h = (j ? function (s, r) {
        s.style.opacity = r;
    } : (g ? function (s, r) {
        ...
        if (r == null || r == 1) {
            p(s, q, "");
            if (r == 1 && i(s) != 1) {
                p(s, q, "alpha(opacity=100)");
            }
        } else {
            p(s, q, "alpha(opacity=" + (r * 100).limit(0, 100).round() + ")");
        }
    } : b));
    var i = (j ? function (s) {
        ...
        var t = (s.style.filter || s.getComputedStyle("filter")), r;
        if (t) {
            r = t.match(q);
        }
        return(r == null || t == null) ? 1 : (r[1] / 100);
    } : function (s) {
        var r = s.retrieve("$opacity");
        if (r == null) {
            r = (s.style.visibility == "hidden" ? 0 : 1);
        }
        return r;
    }));
    var d = (l.style.cssFloat == null) ? "styleFloat" : "cssFloat", a = {left: "0%", top: "0%", center: "50%", right: "100%", bottom: "100%"}, c = (l.style.backgroundPositionX != null);
    var m = function (r, s) {
        if (s == "backgroundPosition") {
            r.removeAttribute(s + "X");
            s += "Y";
        }
        r.removeAttribute(s);
    };
    Element.implement({getComputedStyle: function (t) {
        if (!n && this.currentStyle) {
            return this.currentStyle[t.camelCase()];
        }
        var s = Element.getDocument(this).defaultView, r = s ? s.getComputedStyle(this, null) : null;
        return(r) ? r.getPropertyValue((t == d) ? "float" : t.hyphenate()) : "";
        ...
        s = (s == "float" ? d : s).camelCase();
        if (typeOf(r) != "string") {
            var t = (Element.Styles[s] || "@").split(" ");
            r = Array.from(r).map(function (v, u) {
                if (!t[u]) {
                    return"";
                }
            ...
            if (r == String(Number(r))) {
                r = Math.round(r);
            }
        }
        this.style[s] = r;
        if ((r == "" || r == null) && e && this.style.removeAttribute) {
            m(this.style, s);
        }
        return this;
    }, getStyle: function (x) {
        ...
        x = (x == "float" ? d : x).camelCase();
        var r = this.style[x];
        if (!r || x == "zIndex") {
            if (Element.ShortStyles.hasOwnProperty(x)) {
                r = [];
                for (var w in Element.ShortStyles[x]) {
                    r.push(this.getStyle(w));
                }
                return r.join(" ");
            }
        ...
        if (!r && x == "backgroundPosition") {
            return"0px 0px";
        }
        if (r) {
            r = String(r);
            var u = r.match(/rgba?\([\d\s,]+\)/);
            if (u) {
        ...
        if (!n && !this.style[x]) {
            if ((/^(height|width)$/).test(x) && !(/px$/.test(r))) {
                var t = (x == "width") ? ["left", "right"] : ["top", "bottom"], v = 0;
                t.each(function (s) {
                    v += this.getStyle("border-" + s + "-width").toInt() + this.getStyle("padding-" + s).toInt();
                }, this);
                return this["offset" + x.capitalize()] - v + "px";
            }
            if ((/^border(.+)Width|margin|padding/).test(x) && isNaN(parseFloat(r))) {
                return"0px";
            }
        }
        ...
        var r = {};
        Array.flatten(arguments).each(function (s) {
            r[s] = this.getStyle(s);
        }, this);
        return r;
    }});
    ...
    ["Top", "Right", "Bottom", "Left"].each(function (x) {
        var w = Element.ShortStyles;
        var s = Element.Styles;
        ["margin", "padding"].each(function (y) {
            var z = y + x;
            w[y][z] = s[z] = "@px";
        });
        var v = "border" + x;
        w.border[v] = s[v] = "@px @ rgb(@, @, @)";
        var u = v + "Width", r = v + "Style", t = v + "Color";
        w[v] = {};
        w.borderWidth[u] = w[v][u] = s[u] = "@px";
        w.borderStyle[r] = w[v][r] = s[r] = "@";
...
(function () {
    ...
    var g = {addEvent: function (v, q, x) {
        ...
        if (u) {
            ...
            delete p[u];
            q[m] = p;
            return j.call(this, r, w, l.capture);
        }
        var o, v;
        if (t) {
            for (o in p) {
...
(function () {
    ...
    Element.implement({scrollTo: function (m, n) {
        ...
        if (n) {
            var r = this.getBoundingClientRect(), p = document.id(this.getDocument().documentElement), q = p.getScroll(), t = this.getScrolls(), s = (k(this, "position") == "fixed");
            return{x: r.left.toInt() + t.x + ((s) ? 0 : q.x) - p.clientLeft, y: r.top.toInt() + t.y + ((s) ? 0 : q.y) - p.clientTop};
        }
        var o = this, m = {x: 0, y: 0};
        if (a(this)) {
            return m;
        }
        while (o && !a(o)) {
...
Fx.CSS = new Class({Extends: Fx, prepare: function (b, e, a) {
    ...
    var b = function (e) {
        Array.each(e, function (h, f) {
            if (h.media) {
                b(h.rules || h.cssRules);
                return;
            }
            if (!h.style) {
                return;
            }
            var g = (h.selectorText) ? h.selectorText.replace(/^\w+/, function (i) {
                return i.toLowerCase();
            }) : null;
            if (!g || !c.test(g)) {
                return;
            }
            Object.each(Element.Styles, function (j, i) {
                if (!h.style[i] || Element.ShortStyles[i]) {
                    return;
                }
                j = String(h.style[i]);
